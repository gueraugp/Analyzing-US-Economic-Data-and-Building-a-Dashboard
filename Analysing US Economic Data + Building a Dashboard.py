...
import pandas as pd
GDP = pd.read_csv('https://s3-api.us-geo.objectstorage.softlayer.net/cf-courses-data/CognitiveClass/PY0101EN/projects/coursera_project/clean_gdp.csv',sep=',',)
GDP.head()
...
# Type your code here
unemployment =pd.read_csv('https://s3-api.us-geo.objectstorage.softlayer.net/cf-courses-data/CognitiveClass/PY0101EN/projects/coursera_project/clean_unemployment.csv',sep=',')
unemployment.head()
...
highunemployment = unemployment.loc[unemployment['unemployment']>8.5]
highunemployment
...
unemployment = pd.DataFrame(unemploymente,columns=['unemployment'])
unemployment.head()
...
#
{
  "apikey": "0s03KCR67-q0Fzr7GhSIcI3Tt0fkXCF74u8h1Z9muNC2",
  "endpoints": "https://control.cloud-object-storage.cloud.ibm.com/v2/endpoints",
  "iam_apikey_description": "Auto-generated for key cbcf5232-46ba-4d73-a134-61dbf8151d91",
  "iam_apikey_name": "analyzing-us-economic-data-and-building-a-dashboard-guerau",
  "iam_role_crn": "crn:v1:bluemix:public:iam::::serviceRole:Writer",
  "iam_serviceid_crn": "crn:v1:bluemix:public:iam-identity::a/980012ce8430403d944d50800e1b956f::serviceid:ServiceId-cf425810-6075-4115-a147-2a499576d0d5",
  "resource_instance_id": "crn:v1:bluemix:public:cloud-object-storage:global:a/980012ce8430403d944d50800e1b956f:1c9ced47-e3af-44cb-b4f1-baf8db545057::"
}
...
bucket_name = 'analyzing-us-economic-data-and-building-a-dashboard-guerau'
...
# Fill up the parameters in the following function:
resource.Bucket(name='analyzing-us-economic-data-and-building-a-dashboard-guerau').put_object(Key=, Body=f.read())
